"""
Script para criar atletas com pesagem aprovada em todas as combinações possíveis de chaves
...
class Command(BaseCommand):
    help = 'Cria atletas com pesagem aprovada em todas as combinações possíveis de chaves para testes'

    def add_arguments(self, parser):
        parser.add_argument(
            '--clear',
            action='store_true',
            help='Limpa inscrições e atletas existentes antes de criar novos',
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('\n🌱 Criando atletas para todas as combinações de chaves...\n'))
        ...
        self.stdout.write(f'📊 Total de combinações únicas: {len(categorias_por_combinacao)}')
        
        # Criar atletas para cada combinação
        atletas_criados = 0
        ...
        # Nomes fictícios
        nomes_masculinos = [
            'João Silva', 'Carlos Santos', 'Lucas Oliveira', 'Gabriel Almeida', 'Rafael Costa',
            'Felipe Rodrigues', 'Bruno Ferreira', 'Thiago Martins', 'Matheus Souza', 'Pedro Lima',
            'Vinicius Araújo', 'Gustavo Pereira', 'Leonardo Nunes', 'Rodrigo Barbosa', 'André Luiz',
            'Diego Alves', 'Marcelo Ribeiro', 'Ricardo Campos', 'Fernando Dias', 'Paulo César',
            'Roberto Junior', 'Eduardo Santos', 'Fábio Moreira', 'Daniel Cunha', 'Alexandre Rocha',
            ...
            'Anderson Lima', 'Fabiano Souza', 'Cristiano Rocha', 'Adriano Santos', 'Maurício Pereira',
        ...
        nomes_femininos = [
            ...
            'Amanda Araújo', 'Bruna Pereira', 'Letícia Nunes', 'Jéssica Barbosa', 'Patrícia Luiz',
            'Vanessa Alves', 'Priscila Ribeiro', 'Tatiane Campos', 'Renata Dias', 'Carla César',
            ...
            'Natália Costa', 'Andressa Silva', 'Karina Oliveira', 'Juliana Lima', 'Tainá Souza',
            'Lorena Rocha', 'Nathalia Santos', 'Yasmin Pereira', 'Vitória Almeida', 'Giovanna Ferreira',
        ...
        # Para cada combinação, criar pelo menos 2 atletas (para haver confrontos)
        for (classe_nome, sexo, categoria_nome), categorias_list in categorias_por_combinacao.items():
            ...
            # Criar 2-4 atletas por combinação (para ter confrontos)
            ...
            for i in range(num_atletas):
                ...
                inscricao = Inscricao.objects.create(
                    ...
                    status_inscricao='aprovado',  # Já aprovado
                    peso=peso,  # Peso já registrado
        ...
        self.stdout.write(f'   📝 Inscrições criadas: {inscricoes_criadas}')
        self.stdout.write(f'   ⚖️  Pesagens aprovadas: {pesagens_aprovadas}')
        self.stdout.write(f'   🏆 Campeonato: {campeonato_ativo.nome}')
        self.stdout.write(f'   📋 Combinações cobertas: {len(categorias_por_combinacao)}')
        
        self.stdout.write(self.style.SUCCESS('\n' + '='*60))
        self.stdout.write(self.style.SUCCESS('🎉 Agora você pode gerar todas as chaves!'))
        self.stdout.write(self.style.SUCCESS('='*60 + '\n'))
    ...
    def obter_academias(self):
        ...
        if not academias:
            # Criar academias se não existirem
            academias_data = [
    ...
    def calcular_peso_categoria(self, categoria):
        ...
        if categoria.limite_max:
            ...
            # Peso no meio da faixa, com pequena variação
